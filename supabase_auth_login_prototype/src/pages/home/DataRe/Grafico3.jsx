...
function Tabla() {
    const chart = useChart({
        data: [
            { temp: 0, month: "Enero" },
            { temp: 5, month: "Febrero" },
            { temp: 10, month: "Marzo" },
            { temp: 15, month: "Abril" },
            { temp: 20, month: "Mayo" },
            { temp: 25, month: "Junio" },
            { temp: 30, month: "Julio" },
            { temp: 25, month: "Agosto" },
            { temp: 15, month: "Septiembre" },
            { temp: 10, month: "Octubre" },
            { temp: 5, month: "Noviembre" },
            { temp: 0, month: "Diciembre" },
        ],
    ...
    return (
        <div>
            <h1>Gráfico de Irradiancia vs Meses</h1>
